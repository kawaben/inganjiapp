...
export default function CartPanel() {
    ...
    return (
      <div className={`fixed overflow-y-auto bottom-16 top-16 right-0 w-full md:w-1/3 h-screen bg-[#f8e2d2] shadow-lg transition-transform duration-300 panel p-5 z-10 "translate-x-0" : "translate-x-full"`}>
