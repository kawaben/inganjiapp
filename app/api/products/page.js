...
const products = [
  ...
  { id: 3, name: "Queen of Clubs (Color)", price: 15, image: "/images/product3.jpg", bg: "bg-blue-600" },
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
        {products.map((product) => (
          <Link key={product.id} href={`/products/${product.id}`}>
            <div className="p-4 rounded-lg shadow-lg cursor-pointer bg-red-100 hover:scale-105 transition">
              <div className={`flex items-center justify-center rounded-lg ${product}`}>
